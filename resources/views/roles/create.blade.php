                    ...
                    <div class="row">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        @foreach(\Spatie\Permission\Models\Permission::where('name','LIKE','%return%')->get() as $item)
                                ...
                                <td>
                                    <div class="row">
                                        @foreach(\Spatie\Permission\Models\Permission::where('name','LIKE','%transaction%')->get() as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        @foreach(\Spatie\Permission\Models\Permission::where('name','LIKE','%bank%')->get() as $item)
