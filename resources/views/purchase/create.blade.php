    ...
    <div class="container">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{route('purchase.store')}}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input class="form-control" id="date" name="invoice_number" type="text" placeholder="Enter invoice number" required/>
                        </div>
                        <div class="col-md-6 form-group mb-3">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input class="form-control" id="name" name="item_information"  type="text"
                                   placeholder="Enter product name" required/>
                        </div>
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input class="form-control" id="value1" name="quantity"  step="0" min="0.00" type="number"
                                   placeholder="0.00" required/>
                        </div>
                        <div class="col-md-6 form-group mb-3">
                            <label for="firstName1">rate</label>
                            <input class="form-control" id="value2" name="rate" step="0" min="0.00" type="number"
                                   placeholder="0.00" required/>
                        </div>
                        <div class="col-md-6 form-group mb-3">
                            <label for="firstName1">Total</label>
                            <input class="form-control" id="sum" name="total" step="0" min="0.00" type="number"
                                   placeholder="0.00" />
                        </div>
                                                <div class="col-md-12">
