            ...
            <form enctype="multipart/form-data" method="POST" action="{{route('products.update',$product->id)}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input class="form-control" id="name" name="serial_number" value="{{$product->serial_number}}" type="number"
                               placeholder="Enter Sale Price" required/>
                    </div>
                    <div class="col-md-6 form-group mb-3">
                        <label for="firstName1">Enter Sale Price</label>
                        <input class="form-control" value="{{$product->sale_price}}" id="name" name="sale_price" step="0" min="0.00" type="number"
                               placeholder="Enter Sale Price" required/>
                    </div>
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input class="form-control" value="{{$product->supplier_price}}" id="name" name="supplier_price" step="0" min="0.00" type="number"
