...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::group(['prefix' => 'account'], function(){
    ...
    Route::get('/download/pdf-getin',[GateinController::class, 'downloadPDF']);
    Route::get('/download/pdf-getout',[GateoutController::class, 'downloadPDF']);
    Route::post('/get-categories',[\App\Http\Controllers\Controller::class,'fetchCategories'])->name('fetch-categories');
});
